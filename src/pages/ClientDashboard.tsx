...
const ClientDashboardContent = ({ clientName }: { clientName: string }) => {
  ...
  // Nome do cliente exatamente como vem na planilha (ex: "Prefeitura de Contagem"),
  // com fallback para o nome derivado do slug
  const displayName = useMemo(
    () => clientData[0]?.cliente?.trim() || clientName,
