# Dashboard Filadélfia Comunicação - Campanhas de Mídia Online

Dashboard para visualização e análise de campanhas de mídia online da agência Filadélfia Comunicação. Cliente atual: Prefeitura de Contagem.
...
- ✅ Integração com a planilha Consolidado (Google Sheets via API)
...
│   ├── Header.tsx       # Cabeçalho com logo AD Desk
...
├── images/             # Imagens
│   └── logo_prefeitura_contagem.png # Logo da Prefeitura de Contagem
